using employee.service.Areas.V1.Controllers;
...
namespace employee_service.Test
{
    [TestClass]
    public class EmployeeControllerTest
    {
        #region Initialize 
        Mock<AppSettings> mockAppSettings = null;
        ...
        public void Initialize()
        {
            ...
            mockDatabaseRepository.Setup(ee => ee.GetEmployeeDetailById(Moq.It.IsAny<int>())).Returns(new EmployeeDetail() { Name = "test", Address = "gg", Salary = 333, DeptName = "HR" });
        ...
        {
            var controller = new EmployeeController(mockAppSettings.Object, mockDatabaseRepository.Object);
